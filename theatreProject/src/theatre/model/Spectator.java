...
public class Spectator {
    ...
    private String type; // Child, Student, Full Price
    ...
    public Spectator(String firstName, String lastName, String type, Play play, String chosenRow, int chosenPlace) {
        ...
        this.type = type;
        this.ticket = new Ticket(play.getFullTicketPrice(), type, play, chosenRow, chosenPlace);
    }
    ...
    public String toString() {
        return "Spectator " + this.firstName + " " + this.lastName + "has the ticket: " + this.ticket;
    }
}